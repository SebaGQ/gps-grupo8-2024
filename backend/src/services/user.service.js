...
async function createUser(user) {
  try {
    const { firstName, lastName, rut, email, password, roles } = user;
 ...
 */
async function getUsersByDepartmentNumber(departmentNumber) {
  try {
    ...
    handleError(error, "user.service -> getUsersByDepartmentNumber");
  }
}
...
async function updateUser(id, user) {
  try {
    ...
    const { firstName, lastName, email, rut, password, newPassword, roles } = user;
