...
//     } catch (error) {
//         handleError(error, "binnacle.service -> createBinnacleEntry");
//         return [null, error.message];
//     }
// }
...
//             const [result, error] = await createBinnacleEntry(order.janitorId, "Delivery", description);
//             if (error) {
...
//             const [result, error] = await createBinnacleEntry(visitor.departmentNumber, "Visita", description);
//             if (error) {
...
//             const [result, error] = await createBinnacleEntry(booking.userId, "Espacio Comunitario", description);
//             if (error) {
